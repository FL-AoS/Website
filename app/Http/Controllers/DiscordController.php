...
class DiscordController
{
    private function tokenRevoke(string $access_token)
    {
        ...
        curl_setopt($curl_tk, CURLOPT_HTTPHEADER, ['Content-Type: application/x-www-form-urlencoded']);
    ...
    private function joinDiscord(string $access_token, string $user_id)
    {
        ...
        curl_setopt($curl_join, CURLOPT_HTTPHEADER, ['Content-Type: application/json', 'Authorization: Bot '.env('DISCORD_BOT_TOKEN')]);
    ...
    public function authorize(Request $request)
    {
        ...
        curl_setopt($curl_gu, CURLOPT_HTTPHEADER, ['Authorization: '.$discord_infos->token_type.' '.$discord_infos->access_token]);
