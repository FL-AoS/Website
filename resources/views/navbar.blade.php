...
<body>
	...
	<script type="text/javascript">
		...
		dc.addEventListener("click", () => {
			@guest
			window.location.href = "https://discord.com/oauth2/authorize?client_id=1315347831812263968&response_type=code&redirect_uri={{env('DISCORD_REDIRECT_URI')}}%2Fapi%2Fdiscord%2Fauthorization&scope=identify+guilds.join"
			@endguest
			@auth
